document.addEventListener("DOMContentLoaded", () => {
  ...
  /**
   * Mengatur fungsionalitas dropdown pada menu mobile.
   * Klik pada induk akan membuka submenu.
   */
  function handleMobileDropdowns() {
    ...
    dropdownToggles.forEach((toggle) => {
      toggle.addEventListener("click", function (event) {
        // Jalankan logika ini HANYA di layar mobile
        if (window.innerWidth < 992) {
          ...
          // Tutup semua submenu lain yang mungkin terbuka
          document.querySelectorAll(".nav-links .dropdown-menu.show").forEach((openSubmenu) => {
